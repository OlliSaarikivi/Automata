...
namespace Microsoft.Automata.CSharpFrontend.Benchmark
{
    partial class WindowedAverage10 : Transducer<int, int>
    {
        struct DTStruct5
        {
            ...
            public UInt64 _8;
            public UInt64 _9;
            public DTStruct5(UInt64 v0, UInt64 v1, UInt64 v2, UInt64 v3, UInt64 v4, UInt64 v5, UInt64 v6, UInt64 v7, UInt64 v8, UInt64 v9)
            {
                _0 = v0;
                _1 = v1;
                _2 = v2;
        ...
        public static IEnumerable<Int32> Transduce(IEnumerable<Int32> input)
        {
            unchecked
            {
                ...
                DTStruct5 s = new DTStruct5(((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)), ((ulong)((ulong)0UL)));
                Int32 i;
                M0:
                {
                    if (!ie.MoveNext())
