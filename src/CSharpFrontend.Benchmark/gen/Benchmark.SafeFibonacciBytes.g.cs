...
namespace Microsoft.Automata.CSharpFrontend.Benchmark
{
    partial class SafeFibonacciBytes : Composition<SafeFibonacci, Int32ToBytes>
    {
        ...
        struct DTStruct19
        {
            public UInt32 _0;
            public UInt32 _1;
            public DTStruct19(UInt32 v0, UInt32 v1)
            {
                _0 = v0;
                _1 = v1;
            }
        ...
        public static IEnumerable<Byte> Transduce(IEnumerable<Byte> input)
        {
            unchecked
            {
                ...
                DTStruct19 s = new DTStruct19(((uint)((uint)1U)), ((uint)((uint)1U)));
                Byte i;
                M0:
                {
                    if (!ie.MoveNext())
                    ...
                    i = ie.Current;
                    {
                        ...
                        {
                            var temp3 = Fun0(((uint)(temp0)));
                            if (temp3)
                            {
                                var temp4 = ((uint)(((int)((uint)(temp0))) >> (int)((uint)((uint)24U))));
                                yield return (Byte)(((byte)((uint)(temp4))));
                                var temp5 = ((uint)(((int)((uint)(temp0))) >> (int)((uint)((uint)16U))));
                                yield return (Byte)(((byte)((uint)(temp5))));
                                var temp6 = ((uint)(((int)((uint)(temp0))) >> (int)((uint)((uint)8U))));
                                yield return (Byte)(((byte)((uint)(temp6))));
                                var temp7 = ((byte)(((byte)(((byte)((uint)((s)._0))))) + ((byte)(((byte)((uint)((s)._1)))))));
                                yield return (Byte)(temp7);
        ...
        struct DTStruct20
        {
            public UInt32 _0;
            public UInt32 _1;
            public DTStruct20(UInt32 v0, UInt32 v1)
            {
                _0 = v0;
                _1 = v1;
            }
        ...
        public static void TransduceFromStreamToStream(Stream input, Stream output)
        {
            unchecked
            {
                ...
                int oIndex = 0;
                DTStruct20 s = new DTStruct20(((uint)((uint)1U)), ((uint)((uint)1U)));
                Byte i;
                M0:
                {
                    if (++iIndex >= read)
                    ...
                    i = iBuf[iIndex];
                    {
                        ...
                        else
                        {
                            ...
                            if (temp3)
                            {
                                ...
                                var temp4 = ((uint)(((int)((uint)(temp0))) >> (int)((uint)((uint)24U))));
                                oBuf[oIndex + 0] = (Byte)(((byte)((uint)(temp4))));
                                var temp5 = ((uint)(((int)((uint)(temp0))) >> (int)((uint)((uint)16U))));
                                oBuf[oIndex + 1] = (Byte)(((byte)((uint)(temp5))));
                                var temp6 = ((uint)(((int)((uint)(temp0))) >> (int)((uint)((uint)8U))));
                                oBuf[oIndex + 2] = (Byte)(((byte)((uint)(temp6))));
                                var temp7 = ((byte)(((byte)(((byte)((uint)((s)._0))))) + ((byte)(((byte)((uint)((s)._1)))))));
                                oBuf[oIndex + 3] = (Byte)(temp7);
                                oIndex += 4;
                                UInt32 t1 = ((uint)(temp0));
                                s._0 = ((uint)((s)._1));
                                s._1 = t1;
        ...
        struct DTStruct21
        {
            public UInt32 _0;
            public UInt32 _1;
            public DTStruct21(UInt32 v0, UInt32 v1)
            {
                _0 = v0;
                _1 = v1;
            }
        ...
        public static void TransduceFromArrayToStream(byte[] input, Stream output)
        {
            unchecked
            {
                ...
                var oBuf = new byte[16384];
                int oIndex = 0;
                DTStruct21 s = new DTStruct21(((uint)((uint)1U)), ((uint)((uint)1U)));
                Byte i;
                M0:
                {
